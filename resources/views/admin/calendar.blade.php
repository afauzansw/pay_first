...
<head>
    ...
    <title> Calendar - Pay First </title>
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-2xl font-semibold text-black pb-3"> Calendar </h1>
                <p class="text-xs text-gray-500 mb-6">Dashboard > Calendar</p>
                        ...
                        <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
                            ...
                            <div style=" background-color: rgba(0, 0, 0, 0.8)" class="fixed z-40 top-0 right-0 left-0 bottom-0 h-full w-full" x-show.transition.opacity="openEventModal">
                                <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
                                    ...
                                    <form class="shadow w-full rounded-lg bg-white overflow-hidden block p-8">
